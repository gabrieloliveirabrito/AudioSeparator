...
var modelPath = Path.Combine(Environment.CurrentDirectory, "..", "UVR-MDX.onnx");
...
var builder = MdxBuilder.Create(modelPath)
    .WithOutputStem("vocals")
    .WithResample(true)
    .WithPeakNormalize(true)
    .WithClipPrevention(ClipPreventMode.Rescale)
    .UseFFMPEG(options =>
    {
